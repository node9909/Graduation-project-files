...
void ADS1298_INIT()
{
  ...
  adc_wreg(CONFIG1,0x04); // 250sps
  delay(500);

  adc_wreg(CH1SET,0x91); // ch1 normal operation, gain 1, normal electrode input
  delay(500);  
  adc_wreg(CH2SET,0x91); // CH2 power down, gian 1, input shorted
  delay(500);
  adc_wreg(CH3SET,0x10); // CH2 power down, gian 1, input shorted
  delay(500);
  adc_wreg(CH4SET,0x91); // CH2 power down, gian 1, input shorted
  delay(500);
  adc_wreg(CH5SET,0x10); // CH2 power down, gian 1, input shorted
  delay(500);
  adc_wreg(CH6SET,0x91); // CH2 power down, gian 1, input shorted
  delay(500);
  adc_wreg(CH7SET,0x10); // CH2 power down, gian 1, input shorted
  delay(500);
